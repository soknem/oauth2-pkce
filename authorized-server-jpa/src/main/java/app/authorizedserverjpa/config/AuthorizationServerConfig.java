package app.authorizedserverjpa.config;

import app.authorizedserverjpa.repository.JpaRegisteredClientRepository;
import app.authorizedserverjpa.repository.UserRepository;
import app.authorizedserverjpa.service.CustomUserDetailService;
